...
const updateNasabahCard = (data) => {
    ...
    // navbar nama lengkap
    $('#nama-lengkap').html(`Hi ${data.nama_lengkap.split(" ")[0]}, Selamat Datang!`);
    // id card
...
const updatePersonalInfo = (data) => {
    ...
    // id nasabah
    // $('#idnasabah').html(`${data.id.slice(0, 5)}&nbsp;&nbsp;${dataNasabah.id.slice(5, 9)}&nbsp;&nbsp;${dataNasabah.id.slice(9,99999999)}`);
