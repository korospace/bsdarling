            ...
            if (response.data.statusCode === 200) {
                if (response.data.messages === 'No data can be returned.') {
                    ...
                    response.data.data.forEach(x => {
                        elPostList += `
                        <div class="w-100">
                            <div class="kodepos-list w-100 d-flex align-items-center px-3 py-3" style="cursor: pointer;font-size:16px;" onclick="changeKodeposVal(this,'${x.code}','${x.village}','${x.district}','${x.regency}','${x.province}');">
                                <span class="w-100" style="display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;">
                                    ${x.code} - ${x.village}, ${x.district}, ${x.regency}, ${x.province}
                                </span>
                            </div>
                        </div>`;
                    });
