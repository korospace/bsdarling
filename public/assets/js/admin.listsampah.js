...
const openModalAddEditSmp = (modalName,idSampah=null) => {
    ...
    if (modalName == 'addsampah') {
        ...
        $(`#formAddEditSampah .inputJumlah`).addClass('d-none');
        ...
        $(`#formAddEditSampah .inputJumlah`).removeClass('d-none');
    ...
    if (doValidateAddSmp()) {
        ...
        if (httpResponse.status === 201) {
            ...
            if (httpResponse.message.jumlah) {
                ...
                $('#formAddEditSampah #jumlah-error').text(httpResponse.message.jumlah);
            }
        }
    }
}
...
const doValidateAddSmp = () => {
    ...
    else if ($('#formAddEditSampah #jenis').val().length > 200) {
        $('#formAddEditSampah #jenis').addClass('is-invalid');
        $('#formAddEditSampah #jenis-error').html('*maksimal 200 huruf');
        status = false;
    }
    // harga validation
