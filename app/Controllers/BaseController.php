...
class BaseController extends ResourceController
{
    ...
    public function sendOtpToEmail(String $email,String $otp)
    {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->SMTPSecure = 'ssl';
            $mail->Username   = 'sistembanksampahdarling@gmail.com';
            $mail->Password   = 'xhqnqmwqibspauej';
            $mail->Subject    = 'code OTP';
            $mail->Body       = "Terimakasih sudah bergabung bersama Bank Sampah Darling.<br>berikut adalah code OTP anda:<br><h1>$otp</h1>";

            $mail->setFrom('sistembanksampahdarling@gmail.com', 'Bank Sampah Darling');
    ...
    public function sendKritikSaran(String $userName,String $userEmail,String $message)
    {
        ...
        try {
            ...
            $mail->addAddress('sistembanksampahdarling@gmail.com','Banksampah Darling');
